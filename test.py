...
def whitespace_tokenize(text):
    """
    Source: https://huggingface.co/transformers/v3.2.0/_modules/transformers/tokenization_bert.html
...
def main(flags=None):
    """
    https://github.com/kongds/HBGL/blob/master/test.py

    Removed some of it:
    - --model_type
    - TOKENIZER_CLASSES -> BertTokenizer only
    """
